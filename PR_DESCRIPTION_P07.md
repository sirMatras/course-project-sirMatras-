...
1. **Multi-stage Dockerfile**
   - Базовый образ: `python:3.11-slim@sha256:28ca7b32c4a5eb2578a956a1dd48f765f602f0ce6f8e27b34d0be5e70a97399e` (закреплен SHA256 для воспроизводимости)
...
- SHA256 диджест закреплен для полной воспроизводимости
...
3. **Воспроизводимость:**
   ...
   - SHA256 диджесты базовых образов
   - `--no-cache-dir` для предотвращения использования кеша
